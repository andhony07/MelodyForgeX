...
import { AutomationLaneView } from '../../arrangement/components/AutomationLaneView';
...
export const TrackList: React.FC = () => {
  ...
  const { totalBars, automationEnabled } = useArrangementStore();
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-[#0f1117] relative select-none">
      ...
      {/* Bottom Automation View */}
      {automationEnabled && (
        <div className="max-h-48 overflow-y-auto">
          <AutomationLaneView measureWidth={measureWidth} totalMeasures={totalMeasures} />
        </div>
      )}
    </div>
  );
